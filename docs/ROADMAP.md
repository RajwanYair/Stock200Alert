...
**The honest gap.** None of that is yet a *product a user can open and love*.
...
**One sentence.** *We've built the engine; v6.2 builds the car around it.*
...
**Conclusion of round 2:** the *strategy* in the April roadmap was right. The
*execution priority* has drifted — we kept building library, not product. This
...
- 10 sprints per RC was sustainable; **drop to 5 sprints per RC for v6.2** because each sprint is now a *product activation* (heavier, riskier) rather than a *library module* (light, isolated).
...
### Phase A — v6.2 *Activation* (the central pivot)
...
### Phase B — v6.3 *Streaming, Portfolio & Polish*
...
### Phase C — v6.4 *Reach, Polish, A11y+*
...
### Phase E — v8.0 *Stretch* (everything beyond is wishlist)
...
**Conclusion:** the legacy todo list is overwhelmingly *built but unwired*. v6.2 (Phase A) is mostly an integration sprint, not a build sprint.
...
*End of roadmap. Previous version archived at* `docs/ROADMAP.archive-2026-04.md`.
